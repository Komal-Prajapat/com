                ...
                <form className='ordercheckout_customer_information_container' onSubmit={handleSubmit2}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12} sx={{}}>
                        ...
                        >
                            ...
                            <FormControlLabel value="0" control={<Radio />} label={<p className='adress_text'>Work (Delivery between 10AM to 5PM)</p>} />
                        </RadioGroup>
                    </Grid>
                    <div className='ordercheckout_customer_contact_container'>
                    ...
                    <div className='ordercheckout_customer_contact_field'>
                        ...
                        >
                            <FormControlLabel className='formcontrol' value="0" control={<Radio sx={{ color: "blue" }} />} label={<p>Net Banking</p>} />
